...
export default function GettingStarted({ onLaunch }: { onLaunch: () => void }) {
  return <section className="getting-started" aria-labelledby="getting-started-title">
    <div className="getting-started-head"><div><h2 id="getting-started-title">第一次使用，三步完成</h2><p>每一步都可回頭修改；啟動前仍會執行完整安全檢查。</p></div><button type="button" className="primary-button" onClick={onLaunch}>開始設定</button></div>
    <ol>
